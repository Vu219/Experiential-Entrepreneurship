...
export const STRINGS = {
  vi: {
    ...
    bpSecInfo: 'Thông tin thương hiệu', bpSecPosition: 'Định vị thương hiệu', bpSecSchedule: 'Lịch & Kênh đăng',
    bpfFreq: 'Tần suất đăng', bpfTimes: 'Khung giờ ưu tiên', bpAddKeyword: 'Từ khóa',
    ...
    csTypePh: 'Chọn loại nội dung', csGoalPh: 'Chọn mục tiêu', csStylePh: 'Chọn phong cách', csAddPh: 'Nhập và Enter để thêm',
    // tóm tắt chiến lược
  ...
  en: {
    ...
    bpSecInfo: 'Brand information', bpSecPosition: 'Brand positioning', bpSecSchedule: 'Schedule & channels',
    bpfFreq: 'Posting frequency', bpfTimes: 'Preferred time slots', bpAddKeyword: 'Keyword',
    ...
    csTypePh: 'Choose content types', csGoalPh: 'Choose goals', csStylePh: 'Choose styles', csAddPh: 'Type and press Enter to add',
