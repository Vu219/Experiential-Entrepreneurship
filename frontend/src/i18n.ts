...
export const STRINGS = {
  vi: {
    ...
    errPwWeak: 'Mật khẩu cần tối thiểu 8 ký tự, gồm chữ hoa, chữ thường và số.',
  ...
  en: {
    ...
    errPwWeak: 'Password needs at least 8 characters with uppercase, lowercase and a number.',
